...
public class JadwalUTSFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public JadwalUTSFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_jadwal_uts, container, false);
    ...
    public void loadJadwalUTS(final String token){
        ...
        Call<ResultDataUmum> call = getResponse.getJadwalUTS(token);
