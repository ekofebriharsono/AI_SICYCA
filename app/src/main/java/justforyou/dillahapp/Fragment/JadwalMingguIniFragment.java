...
public class JadwalMingguIniFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public JadwalMingguIniFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_jadwal_minggu_ini, container, false);
        ButterKnife.bind(this, view);

        jadwalKuliahAdapter = new JadwalKuliahAdapter(getContext(), results, false);
        ...
        loadJadwalMingguIni(token);

        return view;
    }

    public void loadJadwalMingguIni(final String token){
        ...
        Call<ResultDataUmum> call = getResponse.getJadwalMingguIni(token);
