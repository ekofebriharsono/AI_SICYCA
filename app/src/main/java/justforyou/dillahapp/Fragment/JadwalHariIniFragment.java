...
public class JadwalHariIniFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public JadwalHariIniFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_jadwal_hari_ini, container, false);
        ...
        loadJadwalHariIni(token);

        return view;
    }

    public void loadJadwalHariIni(final String token){
        ...
        Call<ResultDataUmum> call = getResponse.getJadwalHariIni(token);
